...
ENDHTML
    ...
    ,'comment_notification'=><<<'ENDHTML'
			<p>
				<b>Notificación de comentarios</b>: Enviar una notificación cuando se crea un comentario nuevo
			</p>
...
ENDHTML
    ...
    ,'assigned_notification'=><<<'ENDHTML'
			<p><b>Notificar al agente</b>: Para notificar al agente asignado (ya sea por asignación automática o manual) de tickets nuevos asignados o tickets transferidos</p>
...
ENDHTML
    ...
    ,'agent_restrict'=><<<'ENDHTML'
            <p><b>Restricción de agente</b>: Restringir acceso de los agentes a solo los tickets que tienen asignados</p>
			<p>
			    Un agente solo puedes acceder a los tickets que tiene asignados: <code>1</code>
			</p>
ENDHTML

    ,'close_ticket_perm'=>'<p><b>Permiso para cerrar tickets</b>: ¿Quién tiene permiso para cerrar tickets?</p>','reopen_ticket_perm'=>'<p><b>Permiso para Re-abrir tickets</b>: ¿Quién tiene permiso para re-abrir tickets?</p>','delete_modal_type'=><<<'ENDHTML'
			<p><b>Confirmación para Borrar</b>: Seleccione el tipo de mensaje de confirmación para usar durante el borrado</p>

			<p>Opciones: <code>modal</code>, <code>builtin</code></p>
ENDHTML
...
ENDHTML
    ...
    ,'summernote_options_json_file'=><<<'ENDHTML'
			...
			<p>Esta configuración almacena la ruta al archivo de configuración json, relativa a la ruta del proyecto</p>
ENDHTML

    ,'purifier_config'=><<<'ENDHTML'
			<p>Configurar las etiquetas html son permitidas </p>
			<p>
