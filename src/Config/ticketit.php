...
return [
    ...
    // Ticketit connections (db connection for migrations)
    'connection'    => env('TICKETIT_CONNECTION', 'default_connection'),
    'db_name'       => env('TICKETIT_DB', 'default_db'),

    // Users connections (db connection for migrations)
    'users'         => [
        'connection' => env('TICKETIT_USER_CONNECTION', 'default_connection'),
        'db_name'    => env('TICKETIT_USER_DB', 'default_db'),
    ],
    ...
    'mailable'      => [
        ...
        // Tags for mailable (customized for Laravel Horizon)
        'tags'  => ['emails', 'ticketit'],
    ],

    // Queue for email notification
    'mailablequeue' => 'default',

    // Defaults from getDefaults() on Seeds/SettingsTableSeeder.php
    'defaults'      => [
