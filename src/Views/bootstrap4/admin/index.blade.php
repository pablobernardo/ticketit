    ...
    <div class="col-lg-8 mt-3">
        <div class="card ">
            <div class="card-header d-flex justify-content-between align-items-baseline flex-wrap">
                <div><i class="fas fa-chart-bar fa-fw"></i> {{ trans('ticketit::admin.index-performance-indicator') }}
                </div>
                <div class="btn-group">
...
@section('footer')
@if($tickets_count)
<script src="/assets/google-charts/loader.min.js"></script>
<script type="text/javascript">
    google.charts.load('current', {'name':'visualization','version':'1','packages':['corechart']});
